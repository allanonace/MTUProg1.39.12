...
{
    public partial class ReplaceMeterPage
    {

        public ReplaceMeterPage()
        {
            InitializeComponent();
        }
        ...
        private void InitPickerMeterWorking()
        {
            //This ObservableCollection later we will assign ItemsSource for Picker.
            ObservableCollection<string> objStringList = new ObservableCollection<string>();
            ...
            objClassList.Add(new PickerItems { Name = "Yes" });
            objClassList.Add(new PickerItems { Name = "No" });
            ...
            //Now I am given ItemsSorce to the Pickers
            pickerMeterWorking.ItemsSource = objStringList;
        }
